...
import top.wangudiercai.gulimall.coupon.dao.MemberPriceDao;
import top.wangudiercai.gulimall.coupon.entity.MemberPriceEntity;
import top.wangudiercai.gulimall.coupon.service.MemberPriceService;
...
public class MemberPriceServiceImpl extends ServiceImpl<MemberPriceDao, MemberPriceEntity>
  ...
  public PageUtils queryPage(Map<String, Object> params) {
    IPage<MemberPriceEntity> page =
        this.page(
            new Query<MemberPriceEntity>().getPage(params), new QueryWrapper<MemberPriceEntity>());
