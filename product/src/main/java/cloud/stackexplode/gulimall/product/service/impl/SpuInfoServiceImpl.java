...
import cloud.stackexplode.gulimall.common.to.SkuHasStockVo;
...
import cloud.stackexplode.gulimall.product.vo.BaseAttrVo;
import cloud.stackexplode.gulimall.product.vo.ImageVo;
import cloud.stackexplode.gulimall.product.vo.SkuAttrVo;
  ...
  public void upSpuForSearch(Long spuId) {
    ...
    try {
      ...
      List<SkuHasStockVo> skuHasStocks =
          (List<SkuHasStockVo>) wareFeignService.getSkuHasStocks(longList).get("wares");
      stockMap =
          skuHasStocks.stream()
